            ...
            <v-card class="cardShadow displayCardBackground" style="padding: 12px; text-align: center; background-color: #283046;" height="200px">
              ...
              <div class="col-6" style="display: inline-block;">
                <v-list-item class="displayCard">
                  ...
                  <v-list-item-content style="text-align:left; padding-left: 12px;">
                    <v-list-item-title style="color: #1b9df0;"><b>32,031</b></v-list-item-title>
                    <v-list-item-subtitle style="color: white; font-size: 0.75rem;"><b>USERS SEARCHED<span style="color: #44d62c;">.</span></b></v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
              </div>
              <div class="col-6" style="display: inline-block;">
                <v-list-item class="displayCard">
                  ...
                  <v-list-item-content style="text-align:left; padding-left: 12px;">
                    <v-list-item-title style="color: #7367F0;"><b>32,031</b></v-list-item-title>
                    <v-list-item-subtitle style="color: white; font-size: 0.75rem;"><b>IMAGES ANALYSED<span style="color: #44d62c;">.</span></b></v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
              </div>
              </div>
              ...
              <div class="col-6" style="display: inline-block;">
                <v-list-item class="displayCard">
                  ...
                  <v-list-item-content style="text-align:left; padding-left: 12px;">
                    <v-list-item-title style="color: #FF9F43;"><b>32,031</b></v-list-item-title>
                    <v-list-item-subtitle style="color: white; font-size: 0.75rem;"><b>RECORDS SAVED<span style="color: #44d62c;">.</span></b></v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
              </div>
              </div>
